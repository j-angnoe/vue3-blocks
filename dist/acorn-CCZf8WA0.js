...
var S = { beforeExpr: !0 }, C = { startsExpr: !0 }, ge = {};
function m(e, t) {
...
var Le = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, w = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, Re = Object.prototype, gt = Re.hasOwnProperty, bt = Re.toString, W = Object.hasOwn || function(e, t) {
  return gt.call(e, t);
}, we = Array.isArray || function(e) {
  return bt.call(e) === "[object Array]";
}, Ee = /* @__PURE__ */ Object.create(null);
function B(e) {
  return Ee[e] || (Ee[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"));
}
function L(e) {
...
var Z = 1, z = 2, be = 4, Be = 8, ye = 16, De = 32, ne = 64, Fe = 128, M = 256, J = 512, ue = Z | z | M;
function _e(e, t) {
  return z | (e ? be : 0) | (t ? Be : 0);
}
var te = 0, Ce = 1, O = 2, Me = 3, Ue = 4, qe = 5, b = function(t, i, s) {
  this.options = t = _t(t), this.sourceFile = t.sourceFile, this.keywords = B(ft[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5]);
  var r = "";
  t.allowReserved !== !0 && (r = pe[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3], t.sourceType === "module" && (r += " await")), this.reservedWords = B(r);
  var n = (r ? r + " " : "") + pe.strict;
  this.reservedWordsStrict = B(n), this.reservedWordsStrictBind = B(n + " " + pe.strictBind), this.input = String(i), this.containsEsc = !1, s ? (this.pos = s, this.lineStart = this.input.lastIndexOf(`
...
b.parse = function(t, i) {
  return new this(i, t).parse();
};
b.parseExpressionAt = function(t, i, s) {
  var r = new this(s, t, i);
  return r.nextToken(), r.parseExpression();
};
b.tokenizer = function(t, i) {
  return new this(i, t);
};
Object.defineProperties(b.prototype, N);
var _ = b.prototype, kt = /^(?:'((?:\\[^]|[^'\\])*?)'|"((?:\\[^]|[^"\\])*?)")/;
_.strictDirective = function(e) {
  ...
  for (; ; ) {
    ...
    if ((t[1] || t[2]) === "use strict") {
      ...
      return r === ";" || r === "}" || A.test(i[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(r) || r === "!" && this.input.charAt(s + 1) === "=");
    }
...
_.canInsertSemicolon = function() {
  return this.type === a.eof || this.type === a.braceR || A.test(this.input.slice(this.lastTokEnd, this.start));
};
...
var ke = { kind: "loop" }, St = { kind: "switch" };
p.isLet = function(e) {
  ...
  if (s === 123 || s > 55295 && s < 56320)
    return !0;
  if (T(s, !0)) {
    for (var r = i + 1; G(s = this.input.charCodeAt(r), !0); )
      ++r;
...
p.isAsyncFunction = function() {
  ...
  return !A.test(this.input.slice(this.pos, t)) && this.input.slice(t, t + 8) === "function" && (t + 8 === this.input.length || !(G(i = this.input.charCodeAt(t + 8)) || i > 55295 && i < 56320));
};
...
p.parseDoStatement = function(e) {
  return this.next(), this.labels.push(ke), e.body = this.parseStatement("do"), this.labels.pop(), this.expect(a._while), e.test = this.parseParenExpression(), this.options.ecmaVersion >= 6 ? this.eat(a.semi) : this.semicolon(), this.finishNode(e, "DoWhileStatement");
};
p.parseForStatement = function(e) {
  this.next();
  var t = this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual("await") ? this.lastTokStart : -1;
  if (this.labels.push(ke), this.enterScope(0), this.expect(a.parenL), this.type === a.semi)
  ...
  var n = this.isContextual("let"), u = !1, o = this.containsEsc, h = new oe(), d = this.start, l = t > -1 ? this.parseExprSubscripts(h, "await") : this.parseExpression(!0, h);
  return this.type === a._in || (u = this.options.ecmaVersion >= 6 && this.isContextual("of")) ? (t > -1 ? (this.type === a._in && this.unexpected(t), e.await = !0) : u && this.options.ecmaVersion >= 8 && (l.start === d && !o && l.type === "Identifier" && l.name === "async" ? this.unexpected() : this.options.ecmaVersion >= 9 && (e.await = !1)), n && u && this.raise(l.start, "The left-hand side of a for-of loop may not start with 'let'."), this.toAssignable(l, !1, h), this.checkLValPattern(l), this.parseForIn(e, l)) : (this.checkExpressionErrors(h, !0), t > -1 && this.unexpected(t), this.parseFor(e, l));
};
...
p.parseCatchClauseParam = function() {
  ...
  return this.enterScope(t ? De : 0), this.checkLValPattern(e, t ? Ue : O), this.expect(a.parenR), e;
};
...
p.parseVarId = function(e, t) {
  e.id = this.parseBindingAtom(), this.checkLValPattern(e.id, t === "var" ? Ce : O, !1);
};
var Y = 1, me = 2, je = 4;
...
p.parseClassElement = function(e) {
  ...
  if (s ? (i.computed = !1, i.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i.key.name = s, this.finishNode(i.key, "Identifier")) : this.parseClassElementName(i), t < 13 || this.type === a.parenL || u !== "method" || r || n) {
    var d = !i.static && ie(i, "constructor"), l = d && e;
    d && u !== "method" && this.raise(i.key.start, "Constructor can't have get/set modifier"), i.kind = d ? "constructor" : u, this.parseClassMethod(i, r, n, l);
  } else
...
p.parseClassStaticBlock = function(e) {
  e.body = [];
  var t = this.labels;
  for (this.labels = [], this.enterScope(M | ne); this.type !== a.braceR; ) {
...
p.parseClassId = function(e, t) {
  this.type === a.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, O, !1)) : (t === !0 && this.unexpected(), e.id = null);
};
...
p.parseImportSpecifier = function() {
  ...
  return e.imported = this.parseModuleExportName(), this.eatContextual("as") ? e.local = this.parseIdent() : (this.checkUnreserved(e.imported), e.local = e.imported), this.checkLValSimple(e.local, O), this.finishNode(e, "ImportSpecifier");
};
p.parseImportDefaultSpecifier = function() {
  var e = this.startNode();
  return e.local = this.parseIdent(), this.checkLValSimple(e.local, O), this.finishNode(e, "ImportDefaultSpecifier");
};
p.parseImportNamespaceSpecifier = function() {
  var e = this.startNode();
  return this.next(), this.expectContextual("as"), e.local = this.parseIdent(), this.checkLValSimple(e.local, O), this.finishNode(e, "ImportNamespaceSpecifier");
};
...
I.parseBindingList = function(e, t, i, s) {
...
I.parseMaybeDefault = function(e, t, i) {
...
I.checkLValSimple = function(e, t, i) {
  t === void 0 && (t = te);
  var s = t !== te;
  switch (e.type) {
    case "Identifier":
      this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (s ? "Binding " : "Assigning to ") + e.name + " in strict mode"), s && (t === O && e.name === "let" && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), i && (W(i, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), i[e.name] = !0), t !== qe && this.declareName(e.name, t, e.start));
      break;
    case "ChainExpression":
      this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
      break;
...
I.checkLValPattern = function(e, t, i) {
...
I.checkLValInnerPattern = function(e, t, i) {
  switch (t === void 0 && (t = te), e.type) {
    case "Property":
...
K.braceIsBlock = function(e) {
  ...
  return t === g.f_expr || t === g.f_stat ? !0 : e === a.colon && (t === g.b_stat || t === g.b_expr) ? !t.isExpr : e === a._return || e === a.name && this.exprAllowed ? A.test(this.input.slice(this.lastTokEnd, this.start)) : e === a._else || e === a.semi || e === a.eof || e === a.parenR || e === a.arrow ? !0 : e === a.braceL ? t === g.b_stat : e === a._var || e === a._const || e === a.name ? !1 : !this.exprAllowed;
};
...
a._function.updateContext = a._class.updateContext = function(e) {
  e.beforeExpr && e !== a._else && !(e === a.semi && this.curContext() !== g.p_stat) && !(e === a._return && A.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === a.colon || e === a.braceL) && this.curContext() === g.b_stat) ? this.context.push(g.f_expr) : this.context.push(g.f_stat), this.exprAllowed = !1;
};
...
f.parseMaybeAssign = function(e, t, i) {
  ...
  if (i && (d = i.call(this, d, o, h)), this.type.isAssign) {
    var l = this.startNodeAt(o, h);
    return l.operator = this.value, this.type === a.eq && (d = this.toAssignable(d, !1, t)), s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= d.start && (t.shorthandAssign = -1), this.type === a.eq ? this.checkLValPattern(d) : this.checkLValSimple(d), l.left = d, this.next(), l.right = this.parseMaybeAssign(e), u > -1 && (t.doubleProto = u), this.finishNode(l, "AssignmentExpression");
  } else
...
f.parseExprOp = function(e, t, i, s, r) {
  ...
  if (n != null && (!r || this.type !== a._in) && n > s) {
    ...
    var h = this.value;
    this.next();
    var d = this.start, l = this.startLoc, y = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, r), d, l, n, r), F = this.buildBinary(t, i, e, y, h, u || o);
    return (u && this.type === a.coalesce || o && (this.type === a.logicalOR || this.type === a.logicalAND)) && this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"), this.parseExprOp(F, t, i, s, r);
  }
  return e;
};
...
f.parseSubscript = function(e, t, i, s, r, n, u) {
  ...
  if (d || h && this.type !== a.parenL && this.type !== a.backQuote || this.eat(a.dot)) {
    ...
    l.object = e, d ? (l.property = this.parseExpression(), this.expect(a.bracketR)) : this.type === a.privateId && e.type !== "Super" ? l.property = this.parsePrivateIdent() : l.property = this.parseIdent(this.options.allowReserved !== "never"), l.computed = !!d, o && (l.optional = h), e = this.finishNode(l, "MemberExpression");
  } else if (!s && this.eat(a.parenL)) {
    var y = new oe(), F = this.yieldPos, Q = this.awaitPos, U = this.awaitIdentPos;
    this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0;
    var ee = this.parseExprList(a.parenR, this.options.ecmaVersion >= 8, !1, y);
    if (r && !h && this.shouldParseAsyncArrow())
      return this.checkPatternErrors(y, !1), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = F, this.awaitPos = Q, this.awaitIdentPos = U, this.parseSubscriptAsyncArrow(t, i, ee, u);
    this.checkExpressionErrors(y, !0), this.yieldPos = F || this.yieldPos, this.awaitPos = Q || this.awaitPos, this.awaitIdentPos = U || this.awaitIdentPos;
    var q = this.startNodeAt(t, i);
    q.callee = e, q.arguments = ee, o && (q.optional = h), e = this.finishNode(q, "CallExpression");
    ...
    j.tag = e, j.quasi = this.parseTemplate({ isTagged: !0 }), e = this.finishNode(j, "TaggedTemplateExpression");
  }
  return e;
};
f.parseExprAtom = function(e, t, i) {
  ...
  switch (this.type) {
    ...
    case a.parenL:
      var l = this.start, y = this.parseParenAndDistinguishExpression(r, t);
      return e && (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(y) && (e.parenthesizedAssign = l), e.parenthesizedBind < 0 && (e.parenthesizedBind = l)), y;
    case a.bracketL:
...
f.parseParenAndDistinguishExpression = function(e, t) {
  ...
  if (this.options.ecmaVersion >= 6) {
    this.next();
    var u = this.start, o = this.startLoc, h = [], d = !0, l = !1, y = new oe(), F = this.yieldPos, Q = this.awaitPos, U;
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== a.parenR; )
      if (d ? d = !1 : this.expect(a.comma), n && this.afterTrailingComma(a.parenR, !0)) {
        ...
        U = this.start, h.push(this.parseParenItem(this.parseRestBinding())), this.type === a.comma && this.raiseRecoverable(
          this.start,
          "Comma is not permitted after the rest element"
        );
        break;
      } else
        h.push(this.parseMaybeAssign(!1, y, this.parseParenItem));
    var ee = this.lastTokEnd, q = this.lastTokEndLoc;
    if (this.expect(a.parenR), e && this.shouldParseArrow(h) && this.eat(a.arrow))
      return this.checkPatternErrors(y, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = F, this.awaitPos = Q, this.parseParenArrowList(i, s, h, t);
    (!h.length || l) && this.unexpected(this.lastTokStart), U && this.unexpected(U), this.checkExpressionErrors(y, !0), this.yieldPos = F || this.yieldPos, this.awaitPos = Q || this.awaitPos, h.length > 1 ? (r = this.startNodeAt(u, o), r.expressions = h, this.finishNodeAt(r, "SequenceExpression", ee, q)) : r = h[0];
  } else
...
f.parseNew = function() {
  ...
  return e.callee = this.parseSubscripts(this.parseExprAtom(null, !1, !0), s, r, !0, !1), this.eat(a.parenL) ? e.arguments = this.parseExprList(a.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = At, this.finishNode(e, "NewExpression");
};
...
f.isAsyncProp = function(e) {
  return !e.computed && e.key.type === "Identifier" && e.key.name === "async" && (this.type === a.name || this.type === a.num || this.type === a.string || this.type === a.bracketL || this.type.keyword || this.options.ecmaVersion >= 9 && this.type === a.star) && !A.test(this.input.slice(this.lastTokEnd, this.start));
};
...
var D = b.prototype, It = function(t) {
  this.flags = t, this.var = [], this.lexical = [], this.functions = [];
};
D.enterScope = function(e) {
  this.scopeStack.push(new It(e));
};
D.exitScope = function() {
  this.scopeStack.pop();
};
D.treatFunctionsAsVarInScope = function(e) {
  return e.flags & z || !this.inModule && e.flags & Z;
};
D.declareName = function(e, t, i) {
  var s = !1;
  if (t === O) {
...
function Bt(e) {
  var t = tt[e] = {
    binary: B(Vt[e] + " " + Ie),
    binaryOfStrings: B(Lt[e]),
    nonBinary: {
      General_Category: B(Ie),
      Script: B(Ot[e])
    }
  };
...
var c = b.prototype, ae = function(t, i) {
...
c.regexp_eatRegExpIdentifierName = function(e) {
  if (e.lastStringValue = "", this.regexp_eatRegExpIdentifierStart(e)) {
    for (e.lastStringValue += L(e.lastIntValue); this.regexp_eatRegExpIdentifierPart(e); )
      e.lastStringValue += L(e.lastIntValue);
    return !0;
  }
  return !1;
};
...
c.regexp_eatCharacterClassEscape = function(e) {
  var t = e.current();
  if (Gt(t))
    return e.lastIntValue = -1, e.advance(), R;
  var i = !1;
...
c.regexp_eatUnicodePropertyValueExpression = function(e) {
  ...
  if (this.regexp_eatUnicodePropertyName(e) && e.eat(
    ...
    if (this.regexp_eatUnicodePropertyValue(e)) {
      ...
      return this.regexp_validateUnicodePropertyNameAndValue(e, i, s), R;
    }
  }
...
c.regexp_eatUnicodePropertyName = function(e) {
  ...
  for (e.lastStringValue = ""; rt(t = e.current()); )
    e.lastStringValue += L(t), e.advance();
...
x.next = function(e) {
  !e && this.type.keyword && this.containsEsc && this.raiseRecoverable(this.start, "Escape sequence in keyword " + this.type.keyword), this.options.onToken && this.options.onToken(new Se(this)), this.lastTokEnd = this.end, this.lastTokStart = this.start, this.lastTokEndLoc = this.endLoc, this.lastTokStartLoc = this.startLoc, this.nextToken();
};
x.getToken = function() {
...
x.readToken_plus_min = function(e) {
  var t = this.input.charCodeAt(this.pos + 1);
  return t === e ? t === 45 && !this.inModule && this.input.charCodeAt(this.pos + 2) === 62 && (this.lastTokEnd === 0 || A.test(this.input.slice(this.lastTokEnd, this.pos))) ? (this.skipLineComment(3), this.skipSpace(), this.nextToken()) : this.finishOp(a.incDec, 2) : t === 61 ? this.finishOp(a.assign, 2) : this.finishOp(a.plusMin, 1);
};
...
x.readRegexp = function() {
  for (var e, t, i = this.pos; ; ) {
    ...
    if (A.test(s) && this.raise(i, "Unterminated regular expression"), e)
      e = !1;
    else {
      if (s === "[")
        t = !0;
...
x.readInt = function(e, t, i) {
  for (var s = this.options.ecmaVersion >= 12 && t === void 0, r = i && this.input.charCodeAt(this.pos) === 48, n = this.pos, u = 0, o = 0, h = 0, d = t ?? 1 / 0; h < d; ++h, ++this.pos) {
    var l = this.input.charCodeAt(this.pos), y = void 0;
    if (s && l === 95) {
      r && this.raiseRecoverable(this.pos, "Numeric separator is not allowed in legacy octal numeric literals"), o === 95 && this.raiseRecoverable(this.pos, "Numeric separator must be exactly one underscore"), h === 0 && this.raiseRecoverable(this.pos, "Numeric separator is not allowed at the first of digits"), o = l;
      continue;
    }
    if (l >= 97 ? y = l - 97 + 10 : l >= 65 ? y = l - 65 + 10 : l >= 48 && l <= 57 ? y = l - 48 : y = 1 / 0, y >= e)
      break;
    o = l, u = u * e + y;
  }
...
x.readRadixNumber = function(e) {
  ...
  return i == null && this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110 ? (i = ht(this.input.slice(t, this.pos)), ++this.pos) : T(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(a.num, i);
};
...
x.readWord1 = function() {
  ...
  for (var e = "", t = !0, i = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length; ) {
    ...
    if (G(r, s))
      ...
      (t ? T : G)(u, s) || this.invalidStringToken(n, "Invalid Unicode escape"), e += L(u), i = this.pos;
    } else
      break;
    t = !1;
  }
